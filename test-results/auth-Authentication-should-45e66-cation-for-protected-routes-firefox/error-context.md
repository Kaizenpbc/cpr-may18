...
- Name: Authentication >> should require authentication for protected routes
- Location: C:\Users\gerog\Documents\cpr-may18\src\tests\e2e\auth.spec.ts:96:3
...
Expected string: "http://localhost:5173/login"
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at C:\Users\gerog\Documents\cpr-may18\src\tests\e2e\auth.spec.ts:102:24
```
